<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-room" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Rooms</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-room" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                ...
                <li>
                    <a href="{{ route('categories.index') }}">
                        <i class="bi bi-circle"></i><span>Category Rooms</span>
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Staffs</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="{{ route('staffs.create') }}">
                        <i class="bi bi-circle"></i><span>Add Staffs</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Forms Nav -->
