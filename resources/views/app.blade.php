...
<body>
        ...
        <script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // arahkan ke route print
                    window.location.href = "{{ route('reservation.print', session('reservation_number')) }}";
                } else {
    ...
    <script>
        $('.show_confirm').click(function() {
            Swal.fire({
                ...
                text: "Ini akan menghapus item secara permanen!",
                icon: 'warning',
                showCancelButton: true,
    ...
    <script>
        ...
        category_id.addEventListener('change', async function() {
            ...
            //  axios()
            roomId.innerHTML = "<option  value=''>Select One..</option>"
            try {
                ...
                data.data.forEach(room => {
                    ...
                    option.textContent = `${room.name} - Room ${room.room_number}`;
